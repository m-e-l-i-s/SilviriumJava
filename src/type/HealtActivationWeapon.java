...
public class HealtActivationWeapon extends Weapon{
    public float maxHealthRange = 0.5f;
    public float minHealthRange = 0.0f;
    ...
    public void update(Unit unit, WeaponMount mount){
        boolean can = unit.canShoot() && unit.health <= maxHealthRange*unit.maxHealth && unit.health >= minHealthRange*unit.maxHealth;
